...
inputs[0].focus();
sucesso.classList.add("d-none"); // esconde o certo através da classe de bootstrap igual ao display none
let index = 0;

inputs.forEach(input => {
    input.setAttribute("maxlength", 1); // só pode aceitar no máximo um caracter
